...
void replay()
{
    ...
    do
    {
        ...
        c = link->xto;
        d = link->yto;
        chessPosition[c][d] = link->destination2;
...
void chessBoardBuilding()
{
    ...
    chessPosition[3][9] = White(三);
    chessPosition[4][9] = White(四);
    chessPosition[5][9] = White(五);
    chessPosition[6][9] = White(六);
    chessPosition[7][9] = White(七);
    chessPosition[8][9] = White(八);
    chessPosition[9][9] = White(九);
}
...
void rulesOfAllKindsOfChessPieces()
{
    ...
    // B（龍）----------------------------------------
    else if (chessPosition[xi][yi] == Blue(龍))
    {
        if (yi == yj)
        {
            for (int i = xi + 1; i < xj; i++)
    ...
    // R（馬）----------------------------------------
    else if (chessPosition[xi][yi] == Red(馬))
    {
        int diff = 0;
        diff = abs(xi - xj);
        if ((yi < yj) && (xi < xj))
        ...
        if ((xi != xj && yi != yj) || (xj == xi && yj == yi - 1) || (xj == xi && yj == yi + 1) || (xj == xi + 1 && yj == yi) || (xj == xi - 1 && yj == yi) && isStandard && (redOrBlue(xj, yj) != -1)) //如果棋子直行、沒有犯規且落點不是紅棋，可以移動
        {
            insert(xi, yi, xj, yj, chessPosition[xj][yj]);
            chessPosition[xi][yi] = GAP;
            chessPosition[xj][yj] = Red(馬);          
    ...
    // R（と）----------------------------------------
    else if (chessPosition[xi][yi] == Red(と))
    {
    ...
    // B（と）----------------------------------------
    else if (chessPosition[xi][yi] == Blue(と))
    {
        if ((redOrBlue(xj, yj) != 1) && ((xj == xi - 1 && yj == yi - 1) || (xj == xi - 1 && yj == yi + 1) || (xj == xi - 1 && yj == yi) || (xj == xi + 1 && yj == yi) || (xj == xi && yj == yi - 1) || (xj == xi && yj == yi + 1)))
        {
            insert(xi, yi, xj, yj, chessPosition[xj][yj]);
